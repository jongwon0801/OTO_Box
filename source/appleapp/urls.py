# /home/pi/Workspace/newapp/appleapp/urls.py (춘의동 11013)
...
urlpatterns = [
    #url(r'^logsCams$', views.LogsKivy, name='LogsCams'),
    #url(r'^logsCams/(?P<dirname>[-\w.]+)/$', views.LogsCamsDir, name='LogsCamsDir'),
    #url(r'^logsCams/(?P<dirname>[-\w.]+)/(?P<filename>[-\w.]+)$', views.LogsCamsFile, name='LogsCamsFile'),
    ...
    url(r'^DeviceRegister/', views.DeviceRegister, name='DeviceRegister'),
    url(r'^WifiScan/', views.WifiScan, name='WifiScan'),
    url(r'^TT/', views.TT, name='TT'),
    url(r'^OpenDoor/(?P<controller>[0-9]+)$', views.OpenDoor, name='OpenDoor'),
